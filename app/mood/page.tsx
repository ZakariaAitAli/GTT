                    ...
                    <div className='container flex items-center justify-center'>
                        ...
                        <Card className='py-4 lg:w-3/4 xl:w-1/2'>
                            ...
                            <CardFooter className='flex justify-center'>
                                ...
                                <button type="submit" disabled={data.isSubmit || data.isHours} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover-bg-gradient-to-br focus-ring-4 focus-outline-none focus-ring-blue-300 dark:focus-ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 disabled:opacity-20">
                                    Envoyer
                                </button>
